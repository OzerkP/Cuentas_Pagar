...
<table class="table table-striped">
    ...
    <?php $sql = "select s.id_suplidor,s.empresa,s.nombre_suplidor,s.direccion,s.telefono,s.correo,p.producto_nombre,p.cantidad,pedido.fecha_recibo,pedido.fecha_pago,pedido.modo_pago,pedido.monto,pedido.estado,pedido.id_factura
from cxp 
